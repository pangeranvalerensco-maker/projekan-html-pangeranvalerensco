...
document.addEventListener('DOMContentLoaded', () => {
    // =================================================================================
    // == FEATURE: AUTENTIKASI & MENU AKUN
    // =================================================================================

    // Menambahkan class ke body berdasarkan status login
    ...
    */
     ...
     */
    /* === GANTI FUNGSI updateAccountMenu() ANDA DENGAN BLOK INI === */
    ...
    function updateAccountMenu() {
        ...
        if (isLoggedIn) {
            ...
            myAccountLink.textContent = translations[currentLang]['my-account'];
            ...
            // translateUI(currentLang); // <-- Dihapus karena sudah dipanggil global
            ...
            registerLink.textContent = translations[currentLang]['register'];
 ...
 */
    ...
    // =================================================================================
    // == FEATURE: ORDER PROCESSING & STOCK MANAGEMENT
    // =================================================================================
 ...
 */
    ...
    function updateCartSummary() {
        ...
        if (!userAddress || !userAddress.fullAddress || !userAddress.city || !userAddress.postalCode) {
            ...
            // Lanjutkan ke bagian perhitungan subtotal di bawah
        }

        const selectedProductIds = Array.from(document.querySelectorAll('.cart-item-select input:checked')).map(cb => cb.dataset.productId);
        ...
        try {
            ...
            cart.forEach(cartItem => {
                ...
                if (productDetail) {
                    ...
                    minusBtn.addEventListener('click', () => updateCart(productDetail.id, -1));
                    const quantitySpan = document.createElement('span');
                    quantitySpan.textContent = cartItem.quantity;
                    const plusBtn = document.createElement('button');
                    plusBtn.className = 'quantity-btn';
                    plusBtn.textContent = '+';
                    plusBtn.addEventListener('click', () => updateCart(productDetail.id, 1));
                    ...
                    removeBtn.addEventListener('click', () => updateCart(productDetail.id, 0));
    ...
    // Ganti fungsi validateForm Anda dengan versi ini
 ...
 */
    ...
    // Tambahkan ini di dalam blok DOMContentLoaded

    // Ganti kedua blok logika form Anda dengan ini di script.js
    ...
    // Ganti blok 'if (cartPage)' Anda dengan yang ini di dalam DOMContentLoaded
    ...
    // =================================================================================
    // == FEATURE: CHECKOUT PAGE MANAGEMENT
    // =================================================================================
    ...
    async function initCheckoutPage() {
        ...
        if (checkoutForm) {
            checkoutForm.addEventListener('submit', async (e) => {
                ...
                const { username } = checkLoginStatus();
                if (username) {
                    await processOrder(orderedItems, username);
                }
    ...
    // Ganti event listener lama di body dengan yang ini
